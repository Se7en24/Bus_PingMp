...
class OCR:
    ...
    """
    def __init__(self, device='cpu', identifier_lang='malayalam', verbose=False):
...
if __name__ == '__main__':
    ...
    sample_image_path = 'test_images/bus4.jpeg'
    cropped_image_path = 'test_images/cropped_image/image_141_0.jpg'

    ocr = OCR(device="cpu", identifier_lang='malayalam', verbose=False)
